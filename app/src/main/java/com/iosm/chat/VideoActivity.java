...
public class VideoActivity extends AppCompatActivity {
    ...
    private void initializeAgoraEngine() {
        try {
            mRtcEngine = RtcEngine.create(getBaseContext(), "c060e56a05af46209db727da5841ecd9", mRtcEventHandler);
        } catch (Exception e) {
...
//      mRtcEngine.setVideoProfile(Constants.VIDEO_PROFILE_360P, false); // Earlier than 2.3.0
    ...
    private void joinChannel() {
       //String tunnel = getIntent().getExtras().get("tunnel").toString();
        mRtcEngine.joinChannel(null, "tunnel1", "Extra Optional Data", 0); // if you do not specify the uid, we will generate the uid for you
        //Toast.makeText(this, tunnel, Toast.LENGTH_SHORT).show();
    }
